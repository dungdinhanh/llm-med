...
image_folder=${basefolder}/data/qa50_images
...
cmd="python llava/eval/model_vqa.py \
    --conv-mode mistral_instruct \
    --model-name ${model_name_or_path} \
    --vision-tower ${vision_tower}
    --question-file ${data_path} \
    --image-folder ${image_folder} \
    --answers-file ${answers} --conv-mode vicuna_v1_1"
echo ${cmd}
eval ${cmd}

cmd="python llava/eval/eval_multimodal_chat_gpt_score.py \
...
cmd="python llava/eval/summarize_gpt_review.py --scores-file ${scores}"
echo ${cmd}
eval ${cmd}